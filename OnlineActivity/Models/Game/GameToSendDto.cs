...
namespace OnlineActivity.Models
{
    ...
    public class GameToSendDto
    {
        ...
        [JsonPropertyName("players")] public List<UserToSendDto> Players { get; set; } = new List<UserToSendDto>();

        [JsonPropertyName("creatorId")] public Guid CreatorId { get; set; }

        [JsonPropertyName("gameStartTime")] public DateTime? GameStartTime { get; set; }

        [JsonPropertyName("gameFinishTime")] public DateTime? GameFinishTime { get; set; }

        [JsonPropertyName("canvasLines")] public List<Line> CanvasLines { get; set; } = new List<Line>();
